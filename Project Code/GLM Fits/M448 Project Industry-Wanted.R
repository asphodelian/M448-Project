#########################################
# Course Project: GLM fitting: Industry #
#########################################
...
#0.6369427
glm.fit1 = glm(call~ethnicity+experience+special+reqeduc+industry, train.data, family = "binomial")
summary(glm.fit1)
...
#0.6242038
glm.fit2 = glm(call~ethnicity+experience+honors+holes+special+reqeduc+industry, train.data, family = "binomial")
summary(glm.fit2)
...
#0.6178344
glm.fit3 = glm(call~ethnicity+experience+special+college+reqeduc+reqorg+industry, train.data, family = "binomial")
summary(glm.fit3)
...
#0.6305732
glm.fit4 = glm(call~ethnicity+quality+jobs+honors+volunteer+holes+school+special+reqeduc+reqcomp+industry, train.data, family = "binomial")
summary(glm.fit4)
...
#0.6433121
glm.fit5 = glm(call~ethnicity+experience+special+reqeduc+honors+reqcomp+industry, train.data, family = "binomial")
summary(glm.fit5)
...
glm.fit6= glm(call~gender+quality+jobs+volunteer+military+school+email+computer+college+minimum+equal+requirements+reqexp+reqcomm+industry, train.data, family = "binomial")
summary(glm.fit6)

#0.6433121
glm.fit7 = glm(call~ethnicity+experience+special+reqeduc+honors+reqcomp+requirements+industry, train.data, family = "binomial")
summary(glm.fit7)
...
#0.5987261
glm.fit8 = glm(call~ethnicity+experience+special+reqeduc+honors+industry, train.data, family = "binomial")
summary(glm.fit8)
...
glm.fit9 = glm(call~ethnicity+special+reqeduc+honors+industry, train.data, family = "binomial")
summary(glm.fit9)
...
#0.6050955
glm.fit10 = glm(call~ethnicity+experience+honors+holes+special+reqorg+gender+college+industry, train.data, family = "binomial")
summary(glm.fit10)
...
#0.566879
glm.fit11 = glm(call~ethnicity+experience+honors+holes+special+reqorg+gender+college+school+industry, train.data, family = "binomial")
summary(glm.fit11)
...
#0.5732484
glm.fit12 = glm(call~ethnicity+experience+honors+holes+special+reqorg+gender+college+school+computer+industry, train.data, family = "binomial")
summary(glm.fit12)
