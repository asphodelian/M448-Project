###################################
# The Course Project: No Industry #
###################################
...
qda.fit = qda(call~ethnicity+experience+special+reqeduc, data =  train.data)
qda.fit
...
lda.fit = lda(call~ethnicity+experience+special+reqeduc, data = train.data) 
lda.fit
plot(lda.fit)
...
regfit.full = regsubsets(call~ethnicity+experience+special+reqeduc, data = Names, nvmax = 20)
...
points(4, reg.summary$adjr2[4], col = "purple", cex = 2, pch = 20)
plot(reg.summary$cp, xlab = "Number of Variables", ylab = "Cp",type='l')
which.min(reg.summary$cp)
points(4, reg.summary$cp[4], col = "purple", cex = 2, pch = 20)
...
x = model.matrix(call~ethnicity+experience+special+reqeduc, Names)[,-1]
y = Names$call
dim(x)
